...
public sealed class RuntimeFpsDisplay : MonoBehaviour
{
    ...
    private static RuntimeFpsDisplay _instance;
    private static MinoToolsRuntimeFpsBuildSettings _cachedSettings;
    ...
    public static MinoToolsRuntimeFpsBuildSettings Settings
    {
        get
        {
            ...
            _cachedSettings = Resources.Load<MinoToolsRuntimeFpsBuildSettings>(
                MinoToolsRuntimeFpsBuildSettings.ResourceName);
    ...
    public static void EnsureCreated()
    {
        ...
        _instance = hostObject.AddComponent<RuntimeFpsDisplay>();
    ...
    private static MinoToolsRuntimeFpsBuildSettings CreateFallbackSettings()
    {
        return ScriptableObject.CreateInstance<MinoToolsRuntimeFpsBuildSettings>();
    }
    ...
    private Rect CalculateTextRect(float textWidth, float textHeight, float layoutScale)
    {
        ...
        {
            case MinoToolsRuntimeFpsBuildSettings.PanelAnchor.TopRight:
                return new Rect(safe.xMax - textWidth - margin, safe.y + margin, textWidth, textHeight);
            case MinoToolsRuntimeFpsBuildSettings.PanelAnchor.BottomLeft:
                return new Rect(safe.x + margin, safe.yMax - textHeight - margin, textWidth, textHeight);
            case MinoToolsRuntimeFpsBuildSettings.PanelAnchor.BottomRight:
    ...
    private static TextAnchor GetTextAlignment(MinoToolsRuntimeFpsBuildSettings.PanelAnchor anchor)
    {
        switch (anchor)
        {
            case MinoToolsRuntimeFpsBuildSettings.PanelAnchor.TopRight:
    ...
    private static Color GetFpsColor(float fps, MinoToolsRuntimeFpsBuildSettings config)
    {
