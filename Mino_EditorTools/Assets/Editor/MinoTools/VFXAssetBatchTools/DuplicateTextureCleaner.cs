...
/// </summary>
public class DuplicateTextureCleaner : EditorWindow
{
    private const string MenuPath = "Tools/MinoTools/特效资源工具/重复贴图清理";
    private const string ScanFolderPrefsKey = "MinoTools.DuplicateTextureCleaner.ScanFolder";
    private const string UseFolderScopePrefsKey = "MinoTools.DuplicateTextureCleaner.UseFolderScope";
    ...
    {
        GetWindow<DuplicateTextureCleaner>("重复贴图清理工具");
    }
