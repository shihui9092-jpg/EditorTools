...
/// </summary>
[InitializeOnLoad]
public static class HierarchyGameObjectToggle
{
    private const string EnabledPrefsKey = "MinoTools.HierarchyGameObjectToggle.Enabled";
    ...
    static HierarchyGameObjectToggle()
    {
        RegisterCallbacks();
    }
