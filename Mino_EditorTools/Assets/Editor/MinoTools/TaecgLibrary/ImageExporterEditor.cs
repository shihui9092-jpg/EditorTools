...
namespace taecg.tools
{
    ...
    public class ImageExporterEditor : EditorWindow
    {
        #region 本地化语言
        ...
        private ImageExporterController exporterController;
        ...
        static void Init()
        {
            ImageExporterEditor window = (ImageExporterEditor)EditorWindow.GetWindowWithRect<ImageExporterEditor>(windowRect);
        ...
        { 
            if (isEnabled)
            {
                if (EditorApplication.isPlaying && !EditorApplication.isPaused)
                {
                    ...
                    {
                        ImageExporterController sc = GetOrCreateExporterController();
                        sc.cam = cam;
        ...
        /// </summary>
        private ImageExporterController GetOrCreateExporterController()
        {
            if (exporterController != null)
                return exporterController;

            exporterController = GameObject.FindObjectOfType<ImageExporterController>();
            if (exporterController == null)
            {
                GameObject obj = new GameObject("ScreenShotController");
                exporterController = obj.AddComponent<ImageExporterController>();
            }
